...
struct LabelaryRendererRenderTests {
    ...
    // wInches/hInches are misleadingly named (they actually hold dots, see docs/reviews/
    // code-review_src_2026-07-09.md MEDIUM #10 / GitHub #32), but the arithmetic that
    // follows (dividing by dpi to get widthInches/heightInches) is correct - this is a
    // naming/config bug (ignored timeout, ignored session), not a rounding-order math bug
    // like the one fixed in zpl2png.swift (GitHub #29). Pin that down: render a
